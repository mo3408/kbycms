<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"E:\phpstudy_pro\WWW\www.home.com/application/admin\view\auth_group\lst.htm";i:1584698602;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\head.htm";i:1584698602;s:70:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\top.htm";i:1625984588;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="widget">
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="16%">用户组状态</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <label>
                                        <input id="<?php echo $auth['id']; ?>" status="<?php echo $auth['status']; ?>" onclick="changeStatus(this);" <?php if($auth['status'] == 1): ?> checked="checked" <?php endif; ?> class="checkbox-slider colored-success" type="checkbox">
                                        <span class="text" style="cursor:pointer;"></span>
                                    </label>
                                </td>
                                <td align="center">
                                    <a href="<?php echo url('power',['id'=>$auth['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa  fa-unlock-alt"></i> 权限
                                    </a>
                                    <a href="<?php echo url('edit',['id'=>$auth['id']]); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除用户组和下面的用户吗？', '<?php echo url('del',['id'=>$auth['id']]); ?>')" class="btn btn-danger btn-sm shiny">
                    ...
                    <div style="padding-top:10px; text-align:right;"><?php echo $authRes->render(); ?></div>
                </div>
                <div>
                	                </div>
            </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:72:"D:\phpstudy_pro\WWW\www.kbcms.com/application/admin\view\conf\cftype.htm";i:1584698602;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\head.htm";i:1584698602;s:71:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\top.htm";i:1584698602;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Conf/addcftype'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-body">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center" width="28%">操作</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php if(is_array($confRes) || $confRes instanceof \think\Collection || $confRes instanceof \think\Paginator): $i = 0; $__LIST__ = $confRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center"><?php echo $conf['cf_type']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('sllst',array('id'=>$conf['id'])); ?>" class="btn btn-info btn-sm shiny">
                                    <i class="fa fa-eye"></i> 查看
                                    </a>
                                    <a href="<?php echo url('editcftype',array('id'=>$conf['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('delcftype',array('id'=>$conf['id'])); ?>')" class="btn btn-danger btn-sm shiny">
                ...
                <div style="padding-top:10px; text-align:right;"><?php echo $confRes->render(); ?></div>
            </div>
        </div>
    </div>
</div>

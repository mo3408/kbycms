<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"E:\phpstudy_pro\WWW\www.home.com/application/admin\view\auth_group\edit.htm";i:1584698602;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\head.htm";i:1584698602;s:70:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\top.htm";i:1625984588;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <input type="hidden" name="id" value="<?php echo $authRes['id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">用户组名</label>
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="title" required="" type="text" value="<?php echo $authRes['title']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <!-- 单选 -->
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input  <?php if($authRes['status'] == 1): ?> checked="checked" <?php endif; ?> name="status" value="1" type="radio">
                            ...
                            <!-- 单选 -->
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input <?php if($authRes['status'] == 0): ?> checked="checked" <?php endif; ?> name="status" value="0" type="radio">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"E:\phpstudy_pro\WWW\www.home.com/application/admin\view\login\loginbg3.htm";i:1629883043;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
body {
  background: url(/public/static/admin/canvas_js/4.jpg) no-repeat center top; opacity: 0.8; background-size: cover;
} 
</style>
<canvas id="canvas" ></canvas>
<script src="/public/static/admin/script/jquery-1.10.2.min.js"></script>
<script src="/public/static/admin/canvas_js/index.min.js"></script> 
</body>
</html>

<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"D:\phpstudy_pro\WWW\www.kbcms.com/application/admin\view\conf\lst.htm";i:1584698602;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\head.htm";i:1584698602;s:71:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\top.htm";i:1625984588;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($confRes) || $confRes instanceof \think\Collection || $confRes instanceof \think\Paginator): $i = 0; $__LIST__ = $confRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$conf): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center"><?php if($conf['status'] == 1): ?>是<?php else: ?>否<?php endif; ?></td>
                                <td align="center">

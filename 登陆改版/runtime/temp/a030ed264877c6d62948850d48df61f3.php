<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:75:"D:\phpstudy_pro\WWW\www.kbcms.com/application/admin\view\auth_rule\edit.htm";i:1584698602;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\head.htm";i:1584698602;s:71:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\top.htm";i:1625984588;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('lst'); ?>">规则管理</a>
                    </li>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid" style="width: 100%;">
                                    ...
                                    <option <?php if($rules['pid'] == $rule['id']): ?> selected="selected" <?php endif; ?> value="<?php echo $rule['id']; ?>"><?php echo str_repeat('-',$rule['level']*4)?><?php echo $rule['title']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
                        </div>  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="title" required="" type="text" value="<?php echo $rules['title']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="name" required="" type="text" value="<?php echo $rules['name']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="icon"  type="text" value="<?php echo $rules['icon']; ?>">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <!-- 单选 -->
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input <?php if($rules['status'] == 1): ?> checked="checked" <?php endif; ?> name="status" value="1" type="radio">
                            ...
                            <!-- 单选 -->
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input <?php if($rules['status'] == 0): ?> checked="checked" <?php endif; ?>  name="status" value="0" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <!-- 单选 -->
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input <?php if($rules['show'] == 1): ?> checked="checked" <?php endif; ?> name="show" value="1" type="radio">
                                        <span class="text">是</span>
                                    </label>
                                </div>
                            ...
                            <!-- 单选 -->
                                <div class="radio" style="float:left; padding-left:10px;">
                                    <label>
                                        <input <?php if($rules['show'] == 0): ?> checked="checked" <?php endif; ?>  name="show" value="0" type="radio">
                                        <span class="text">否</span>
                                    </label>
                                </div>

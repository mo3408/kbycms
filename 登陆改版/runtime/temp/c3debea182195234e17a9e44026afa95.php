<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:69:"E:\phpstudy_pro\WWW\www.home.com/application/admin\view\model\lst.htm";i:1584698602;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\head.htm";i:1584698602;s:70:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\top.htm";i:1625984588;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="widget">
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($modelRes) || $modelRes instanceof \think\Collection || $modelRes instanceof \think\Paginator): $i = 0; $__LIST__ = $modelRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$model): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center"><a href="<?php echo url('ModelFields/lst',array('model_id'=>$model['id'])); ?>"><?php echo $model['model_name']; ?></a></td>
                                <td align="center"><?php echo $prefix; ?><?php echo $model['table_name']; ?></td>
                                <td align="center">
                                    <?php if($model['status'] == 1): ?>
                                    <a modelid="<?php echo $model['id']; ?>" onclick="changestatus(this);" class="btn btn-primary btn-sm shiny">
                                        启用 
                                     </a>
                                    <?php else: ?>
                                    <a modelid="<?php echo $model['id']; ?>" onclick="changestatus(this);" class="tn btn-danger btn-sm shiny" style="cursor: pointer;">禁用</a>
                                    <?php endif; ?>
                                </td>
                                <td align="center">
                                <a href="<?php echo url('ModelFields/lst',array('model_id'=>$model['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-tasks"></i> 字段
                                    </a>
                                    <a href="<?php echo url('Model/edit',array('model_id'=>$model['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" id="<?php echo $model['id']; ?>" table_name="<?php echo $prefix; ?><?php echo $model['table_name']; ?>" onClick="ajaxdel(this);" class="btn btn-danger btn-sm shiny">
                    ...
                    <div style="padding-top:10px; text-align:right;"><?php echo $modelRes->render(); ?></div>
                </div>

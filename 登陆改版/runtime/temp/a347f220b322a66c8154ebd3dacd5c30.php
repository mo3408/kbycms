<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:76:"E:\phpstudy_pro\WWW\www.home.com/application/admin\view\auth_group\power.htm";i:1584698602;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\head.htm";i:1584698602;s:70:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\top.htm";i:1625984588;s:71:"E:\phpstudy_pro\WWW\www.home.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="title" required="" type="text" value="<?php echo $authGroups['title']; ?>">
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <label style="padding-left:10px;">
                                                    <input id="<?php echo $vo['id']; ?>" value="<?php echo $vo['id']; ?>" name="rules[]" dataid="id-<?php echo $vo['id']; ?>" class="colored-blue checkbox-parent" type="checkbox"  <?php if(in_array($vo['id'],$rules)): ?> checked="checked" <?php endif; ?>>
                                        ...
                                        <?php if(is_array($vo['children']) || $vo['children'] instanceof \think\Collection || $vo['children'] instanceof \think\Paginator): if( count($vo['children'])==0 ) : echo "" ;else: foreach($vo['children'] as $key=>$vo2): ?>
                                            <tr>
                                                <td style="padding-left:30px;">
                                                    <label style="padding-left:10px;">
                                                        <input class="colored-blue  checkbox-parent checkbox-child" id="<?php echo $vo2['id']; ?>" value="<?php echo $vo2['id']; ?>" name="rules[]" dataid="id-<?php echo $vo['id']; ?>-<?php echo $vo2['id']; ?>"  type="checkbox"  <?php if(in_array($vo2['id'],$rules)): ?> checked="checked" <?php endif; ?>>
                                            ...
                                            <tr>
                                               <td style="padding-left:60px;">
                                                <?php if(is_array($vo2['children']) || $vo2['children'] instanceof \think\Collection || $vo2['children'] instanceof \think\Paginator): if( count($vo2['children'])==0 ) : echo "" ;else: foreach($vo2['children'] as $key=>$vo3): ?>
                                                        <label style="padding-left:10px;">
                                                            <input class="colored-blue checkbox-child" id="<?php echo $vo3['id']; ?>" value="<?php echo $vo3['id']; ?>" name="rules[]" dataid="id-<?php echo $vo['id']; ?>-<?php echo $vo2['id']; ?>-<?php echo $vo3['id']; ?>"  type="checkbox" <?php if(in_array($vo3['id'],$rules)): ?> checked="checked" <?php endif; ?>>

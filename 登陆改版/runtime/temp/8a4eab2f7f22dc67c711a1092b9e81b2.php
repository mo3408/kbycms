<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"D:\phpstudy_pro\WWW\www.kbcms.com/application/admin\view\auth_rule\lst.htm";i:1584698602;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\head.htm";i:1584698602;s:71:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\top.htm";i:1625984588;s:72:"D:\phpstudy_pro\WWW\www.kbcms.com\application\admin\view\common\left.htm";i:1584698602;}*/ ?>
    <!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加规则" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('add'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($ruleTree) || $ruleTree instanceof \think\Collection || $ruleTree instanceof \think\Paginator): $i = 0; $__LIST__ = $ruleTree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rule): $mod = ($i % 2 );++$i;?>
                            ...
                            <td align="center"><span class="opens">+</span></td>
                                ...
                                <td ><?php echo str_repeat('-',$rule['level']*4)?><?php echo $rule['title']; ?></td>
                                <td align="center"><?php if($rule['status'] == 1): ?><span class="label label-palegreen">是</span><?php else: ?><span class="label label-orange">否</span><?php endif; ?></td>
                                <td align="center"><?php if($rule['show'] == 1): ?>
                                <span class="label label-palegreen">是</span>
                                <?php else: ?><span class="label label-orange">否</span><?php endif; ?></td>
                                <td align="center">

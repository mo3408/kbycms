...
<script type="text/javascript">
    			...
    			<div class="page-content">
    				...
    				<div class="page-breadcrumbs">
    					<ul class="breadcrumb">
    						...
    						<li><a
    								href="<?php echo url('content/lsts',(['cate_id'=>$cate['id'],'model_id'=>$cate['model_id']])); ?>"><?php echo $cate['cate_name']; ?></a>
    						</li>
    						...
    						<li><a
    								href="<?php echo url('cate/cateList',(['cate_id'=>$cate['id'],'model_id'=>$cate['model_id']])); ?>"><?php echo $cate['cate_name']; ?></a>
    						</li>
    					...
    					<div class="row">
    						<div class="col-lg-12 col-sm-12 col-xs-12">
    									...
    									<div id="horizontal-form">
    										<form enctype="multipart/form-data" class="form-horizontal" role="form"  id="content_form">
    											...
    											<div class="form-group">
    												...
    												<div class="col-sm-6">
    													<select <?php if($cate_id != ''): ?> disabled="disabled"
    														<?php endif; ?> name="cate_id">
    											...
    											<div class="form-group">
    												<label for="username"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['1']; ?></label>
    												<div class="col-sm-6">
    													<!-- 单选 -->
    													<div class="radio" style="float:left; padding-left:10px;">
    														<label>
    											...
    											<div class="form-group">
    												<label for="username"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['9']; ?></label>
    												<div class="col-sm-6">
    													<!-- 单选 -->
    													<div class="radio" style="float:left; padding-left:10px;">
    														<label>
    											...
    											<div class="form-group">
    												<label for="username"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['2']; ?></label>
    												<div class="col-sm-6">
    											...
    											<div class="form-group">
    												<label for="username"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['7']; ?></label>
    												<div class="col-sm-6">
    											...
    											<div class="form-group">
    												<label for="username"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['8']; ?></label>
    												<div class="col-sm-6">
    											...
    											<div class="form-group">
    												<label for="username"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['6']; ?></label>
    												<div class="col-sm-6">
    											...
    											<div class="form-group">
    												<label for="group_id"
    													class="col-sm-2 control-label no-padding-right"><?php echo $v['field_cname']; ?></label>
    												<div class="col-sm-6">
    													<?php
                                ...
                                ?>
    											...
    											<div class="form-group">
    												<label for="group_id"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['3']; ?></label>
    												<div class="col-sm-6">
    											...
    											<div class="form-group">
    												<label for="group_id"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['4']; ?></label>
    												<div class="col-sm-6">
                        ...
                        <div class="form-group" id="imgdiv" style="display:none;">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control"  placeholder="" name="click" required="" type="text">
    											...
    											<div class="form-group">
    												<label for="group_id"
    													class="col-sm-2 control-label no-padding-right"><?php echo $adShows['5']; ?></label>
    												<div class="col-sm-6">
   ...
   <script type="text/javascript">
		 ...
		 CKEDITOR.replace('content',{
			...
			filebrowserBrowseUrl :  '/public/static/admin/ckeditor/ckfinder/ckfinder.html',
			filebrowserImageBrowseUrl :  '/public/static/admin/ckeditor/ckfinder/ckfinder.html?Type=Images',
			filebrowserFlashBrowseUrl :  '/public/static/admin/ckeditor/ckfinder/ckfinder.html?Type=Flash',
			filebrowserUploadUrl :  '/public/static/admin/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files',
			filebrowserImageUploadUrl  :  '/public/static/admin/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
			filebrowserFlashUploadUrl  :  '/public/static/admin/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash'
			});
    					...
    					if (data.code == 1) {
    						layer.msg(data.msg, {
    							...
    							time: 600,
    								...
    								window.location.href =
    									'<?php echo url("content/lsts",["cate_id"=>$cate_id,"model_id"=>$model_id]); ?>';
    							}
    						});
    					} else {
    						layer.msg(data.msg, {
